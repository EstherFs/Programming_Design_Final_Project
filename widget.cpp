...
{
    QMessageBox msgBox;
    msgBox.setText("Please insert bills or import a CSV file.");
    msgBox.setWindowTitle("Guideline 1/4");
    msgBox.setStandardButtons(QMessageBox::Ok);
    msgBox.exec();

    QMessageBox msgBox;
    msgBox.setText("Then you can choose to delete a bill or check the statistic to split the bill.");
    msgBox.setWindowTitle("Guideline 2/4");
    msgBox.setStandardButtons(QMessageBox::Ok);
    msgBox.exec();

    QMessageBox msgBox;
    msgBox.setText("When you want to save the database, you should export a CSV file for next time.");
    msgBox.setWindowTitle("Guideline 3/4");
    msgBox.setStandardButtons(QMessageBox::Ok);
    msgBox.exec();
    
    QMessageBox msgBox;
    msgBox.setText("By the way, you can hide the table and change the background picture.");
    msgBox.setWindowTitle("Guideline 4/4");
    msgBox.setStandardButtons(QMessageBox::Ok);
    msgBox.exec();
}
